...
function cargarDatos() {
    let container = document.getElementById("datosPropiedades");
    container.innerHTML = "";

    datos.propiedades.forEach(propiedad => {
        let contenedorPropiedad = `<div class="col-md-4">
        ...
        container.innerHTML += contenedorPropiedad;
